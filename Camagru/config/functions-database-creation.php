...
{
$bdd->query("LOAD DATA LOCAL INFILE 'macOS⁩/goinfre⁩/ltreu⁩/⁨Documents⁩/Mamp⁩/apache2⁩/htdocs⁩/Cam⁩agru/config⁩/users.csv'
...
{
	$bdd->query("LOAD DATA LOCAL INFILE 'macOS⁩/goinfre⁩/ltreu⁩/⁨Documents⁩/Mamp⁩/apache2⁩/htdocs⁩/Cam⁩agru/config⁩/photos.csv'
	INTO TABLE `photos`
	FIELDS TERMINATED BY ','
	LINES TERMINATED BY '\r\n'
...
{
	$bdd->query("LOAD DATA LOCAL INFILE 'macOS⁩/goinfre⁩/ltreu⁩/⁨Documents⁩/Mamp⁩/apache2⁩/htdocs⁩/Cam⁩agru/config⁩/likes.csv'
	INTO TABLE `likes`
	FIELDS TERMINATED BY ','
	LINES TERMINATED BY '\r\n'
...
{
	$bdd->query("LOAD DATA LOCAL INFILE 'macOS⁩/goinfre⁩/ltreu⁩/⁨Documents⁩/Mamp⁩/apache2⁩/htdocs⁩/Cam⁩agru/config⁩/comments.csv'
	INTO TABLE `comments`
	CHARACTER SET UTF8
	FIELDS TERMINATED BY ','
	LINES TERMINATED BY '\r\n'
...
{
	$bdd->query("LOAD DATA LOCAL INFILE 'macOS⁩/goinfre⁩/ltreu⁩/⁨Documents⁩/Mamp⁩/apache2⁩/htdocs⁩/Cam⁩agru/config⁩/filters.csv'
	INTO TABLE `filters`
	CHARACTER SET UTF8
	FIELDS TERMINATED BY ','
	LINES TERMINATED BY '\r\n'
