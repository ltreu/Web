...
<body>
	<div class="center">
		...
		echo "<p class='text' style='text-align:center;'>Photo by <a href='../Fixtures/fixtures-users.php?login=".$data[0]['login']."'>".$data[0]['login']."</a></p>";
		$result = picture_belong_to_user($id);
		if ($result > 0 || $_SESSION['groupe'] == 'admin')
		{
			echo "<a href='delete-picture.php?id-photo=".$id."' id='delete-picture' class='fake-link'>Delete this photo</a><br/>";
		}
